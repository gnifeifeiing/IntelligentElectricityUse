 ...
 * Description:      描述
 * Autour：          LF
 * Date：            2018/3/29 11:02
 */

public class HistoryAlarmListModule  extends BaseModule{
    ...
    private int sCount;
    private int fCount;
    private List<HistoryAlarmModule> rows;
    ...
    public List<HistoryAlarmModule> getRows() {
        return rows;
    }

    public void setRows(List<HistoryAlarmModule> rows) {
        this.rows = rows;
    }

    public static class HistoryAlarmModule implements Serializable{
        private String id;
