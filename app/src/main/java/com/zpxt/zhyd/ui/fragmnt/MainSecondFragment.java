...
public class MainSecondFragment extends BaseFragment {
    ...
    public void initView() {
        mRecyclerView = mView.findViewById(R.id.mainSecond_recyclerview);

        mAdapter = new MainSecondAdapter(getActivity(), mList,getResources().getStringArray(R.array.alarm_detail_type)[1]);
