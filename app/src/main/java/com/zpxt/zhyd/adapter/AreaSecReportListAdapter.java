...
/**
 * Description:      预警列表适配器--第二页
 * Autour：          LF
 * Date：            2018/3/22 16:36
 */

public class AreaSecReportListAdapter extends RecyclerView.Adapter<AreaSecReportListAdapter.MyViewHolder> {
    ...
    public AreaSecReportListAdapter(Context context, List<AlarmListModule.AlarmModule> list, String pType){
