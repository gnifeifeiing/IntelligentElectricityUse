 ...
 * Description:      预警列表适配器
 * Autour：          LF
 * Date：            2018/3/22 15:33
 */

public class AreaReportListAdapter extends RecyclerView.Adapter<AreaReportListAdapter.MyViewHolder> {
    ...
    public AreaReportListAdapter(Context context,List<AlarmListModule.AlarmModule> list,String pType){
        ...
        public MyViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(mList.get(getPosition()).getNodeType().equals("BOTTOM")){
                        //检测周报日期列表
                        ...
                        Intent intent=new Intent(mContext, AreaSecReportListActivity.class);
                        intent.putExtras(bundle);
                        mContext.startActivity(intent);
                    }
                }
